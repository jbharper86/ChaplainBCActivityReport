...
public enum ServiceCode implements Serializable {
	...
	_561A("MSW Initial Assessment", true),
	_561A1("After Hours MSW Initial Assessment (<2 hours)", true),
	_561A2("After Hours MSW Initial Assessment (>2 hours)", true),
	_561BRV("MSW Bereavement Visit", true),
	_561BRV1("After Hours MSW Bereavement Visit (<2 hours)", true),
	_561BRV2("After Hours MSW Bereavement Visit (>2 hours)", true),
	_561BSW("Bachelor of Social Work Visit", true),
	_561PRN("MSW PRN Visit", true),
	_561R("MSW Visit", true),
	_561R1("After Hours MSW Visit (<2 hours)", true),
	_561R2("After Hours MSW Visit (>2 hours)", true),
	_561REC("Social Worker Recertification Visit", true),
	_561REV("Social Worker Doing Revocation without a vist", true),
	_561RS("MSW Visit with Supervisory BSW", true),
	_561SSW("Supervisory BSW", true),
	_569CAL("Social Worker Phone Call (not scheduled for freq., enter as visit w/ code", true),
	_569ACAL("Attempted Social Worker Phone Call", true);
